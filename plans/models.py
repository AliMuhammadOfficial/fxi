...
class Plan(models.Model):
    ...
    roi_period = models.CharField(
        max_length=255, choices=PERIOD, default=DAILY)
    plan_period = models.CharField(
        max_length=255, choices=PLAN_PERIOD, default=LIFE_TIME)
...
class Investment(models.Model):
    ...
    interest = models.DecimalField(max_digits=12, decimal_places=3)
